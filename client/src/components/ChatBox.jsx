    ...
    "
      >
        <input
          ...
          className="flex-grow font-lotr p-2 text-[#1B3A2E] bg-[#E2D6B3] placeholder-[#7D7D7D] focus:outline-none text-sm sm:text-base"
          value={input}
          disabled={loading}
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-[#C5A300] text-[#1B3A2E] font-lotr px-4 sm:px-6 hover:bg-[#FFD700] transition-colors"
        >
          Send
        </button>
      </form>
